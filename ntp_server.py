...
FAKE_TIME = 1450137600.00000 # Midnight
#FAKE_TIME = 1450137900.00000 # Midnight + 5 min
#FAKE_TIME = 1450138200.00000 # Midnight + 10 min
#FAKE_TIME = 1450138320.00000 # Midnight + 12 min
            ...
            if len(rlist) != 0:
                ...
                for tempSocket in rlist:
                    try:
                        ...
                        recvTimestamp = recvTimestamp = system_to_ntp_time(FAKE_TIME)
    ...
    def run(self):
        ...
        while True:
            ...
            try:
                ...
                sendPacket.tx_timestamp = system_to_ntp_time(FAKE_TIME)
